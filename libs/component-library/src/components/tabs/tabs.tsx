...
const TabsList = React.forwardRef<HTMLDivElement, TabsListProps>(
  ({ className, ...props }, ref) => (
    <TabsPrimitive.List
      ref={ref}
      className={cn(
        "bg-olive-3 text-slate-11 inline-flex h-10 items-center justify-start gap-1 rounded-md p-1",
        className,
      )}
      {...props}
    />
  ...
  ({ className, ...props }, ref) => (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "data-[state=active]:bg-olive-3 data-[state=active]:text-slate-12 data-[state=active]:border-grass-9 data-[state=active]:border-b-2",
